...
ChromeExtensionHandler.prototype = {
  ...
  registerExtensionChange : function(pkg, path, projectURI) {
  	//trace("[ChromeExtensionHandler.registerExtensionChange] " + pkg + ", " + path + ", " + projectURI);
	...
	//trace('[ChromeExtensionHandler.registerExtensionChange] registered('+changeXChromeExtension.baseUriLength+', '+changeXChromeExtension.getXchromeBaseUri()+')');
